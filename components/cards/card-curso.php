<?php
echo
'<div class="card mb-3 font" style="max-width: 540px; background-color: transparent">
    <div class="row g-0" style="width: 100%">
        <div class="col-3 p-0 m-0">
            <img src="../imagens/cursos/ADS.png" class="img-fluid rounded-3 imagem-curso" alt="...">
        </div>
            ...
            <div class="card-body d-flex flex-column p-0 m-0">
                ...
                <p class="card-text p-0 m-0 text-white " style="font-size: 10px; font-weight: lighter">Modalidades: Presencial | Semipresencial | EAD</p>
